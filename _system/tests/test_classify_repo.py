...
def test_repo_with_readme_classifies_into_existing_domain(db_with_domain):
    ...
    result = classify(
        ...
        call_llm=_runner_from_dict({
            ...
            "new_domain_desc": "",
            "collection_index": -1,
            "new_collection": "demo_collection",
            "new_collection_desc": "Cluster of work demos.",
...
def test_rerun_replaces_topics(db_with_domain):
    """Re-running classify on a repo replaces its prior topic rows."""
    rid = _seed_repo(db_with_domain)
    embedder = _OrthogonalEmbedder()
    ...
    classify(
        ...
        call_llm=_runner_from_dict({
            ...
            "new_domain_desc": "",
            "collection_index": -1,
            "new_collection": "first_cluster",
            "new_collection_desc": "Cluster A.",
            "topics": ["alpha", "beta"],
        }),
        embedder=embedder,
    )
...
def test_domain_override_skips_llm_domain_choice(db_with_domain):
    ...
    result = classify(
        ...
        call_llm=_runner_from_dict({
            "domain_index": 0,  # LLM picked rag
            "new_domain": "",
            "new_domain_desc": "",
            "collection_index": -1,
            "new_collection": "evolution",
            "new_collection_desc": "Evolution work.",
            "topics": ["phylogeny"],
        }),
        embedder=embedder,
    )
